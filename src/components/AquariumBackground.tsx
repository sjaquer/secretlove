...
export function AquariumBackground() {
  ...
  return (
    <div className="absolute inset-0 -z-10 h-full w-full overflow-hidden bg-gradient-to-b from-[#005c9d] via-[#007cb0] to-[#2da8d1]">
      ...
      <div style={parallaxStyle(5)} className="absolute inset-0 blur-sm">
          <Image src="https://i.ibb.co/Fkz2RNf/siluate-pez.png" alt="fish school silhouette" width={300} height={150} data-ai-hint="fish school" className="absolute top-[15%] left-[5%] opacity-10" />
          <Image src="https://i.ibb.co/XPH6tZf/siluate-pez-200.png" alt="fish school silhouette" width={200} height={100} data-ai-hint="swimming fish" className="absolute top-[25%] right-[10%] opacity-10" />
      </div>
      ...
      <div style={parallaxStyle(30)} className="absolute inset-0 blur-lg">
      ...
      <div style={parallaxStyle(50)} className="absolute inset-0 blur-lg">
